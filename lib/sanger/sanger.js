...
exports.new = function(req, callback){
    var productData = req.body[SANGER_CONSTATNTS['product_data']];
...
exports.update = function(req, callback){
    var productNewData = req.body[SANGER_CONSTATNTS['product_data']];

    Product.findOne({ _id: req.params['_id'] }, function (err, doc){
    ...
    callback({data: 'Ok. i\'ll update and re-index.', product_data: productData});
};
...
function indexInElastic(product){
    var payload = {};
    payload[SANGER_CONSTATNTS['product_data']] = product._doc;
